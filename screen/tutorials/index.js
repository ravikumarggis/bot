...
const Tutorials = () => {
  ...
  return (
    <div className="relative w-full flex flex-col bg-[#05060f] text-white py-30 px-5 md:px-20 gap-10">
      ...
      <div className="bg-black text-center p-8 md:p-12 flex flex-col items-center justify-center cursor-pointer" onClick={openModal}>
        ...
        <h2 className="text-white text-xl md:text-2xl font-semibold mb-4">
          How to Connect Binance with ARBIQUE?
        </h2>

        <p className="text-gray-400 text-sm md:text-base leading-relaxed">
          Learn how to generate an API key within Binance and securely link it to ARBIQUE for automated and seamless trading.
        </p>
