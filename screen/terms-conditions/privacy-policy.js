    ...
    <div className="relative w-full flex flex-col bg-[#05060f]  py-30 px-5 md:px-20 gap-10">
        ...
        <div>
          <p className="text-sm  md:text-md">
            Welcome to ARBIQUE, a cloud-based crypto trading platform. We offer
            ARBIQUE as a software solution ("Platform") through our website
            https://arbique.com ("Website"). Our Platform provides users with an
            ...
            between ARBIQUE and its customers, including details of our
            ...
            dispute resolution procedures. 1. Definitions 1.1 ARBIQUE Account:
            The user account on the Platform, accessible only via the user's
            login credentials. 1.2 Platform: ARBIQUE’s automated crypto trading
            system, enabling users to trade and invest through configurable
            strategies and tools. 1.3 Services: Collectively, the ARBIQUE
            Platform and Website. 1.4 Fuel Wallet: The pre-funded digital wallet
            within the ARBIQUE Account used for deducting profit-based
            ...
            legal entity utilizing ARBIQUE's Services. 1.7 Login Credentials:
            The email address and password used to access an ARBIQUE Account. 2.
            Registration & Personal Account 2.1 To access ARBIQUE's Services,
            ...
            applicable laws and ARBIQUE's internal policies. 2.3 Users are
            ...
            to ARBIQUE immediately. 2.4 Users must ensure that all registration
            details and personal information provided are accurate, complete,
            and kept up-to-date. ARBIQUE is not liable for any losses arising
            from outdated or inaccurate information. 2.5 ARBIQUE reserves the
            ...
            3.1 ARBIQUE provides an automated crypto trading assist tool. This
            ...
            Configuration: Users acknowledge and agree that ARBIQUE is a
            software solution that executes trades based solely on the
            configurations and parameters set by the User. ARBIQUE does not
            ...
            Guarantees: ARBIQUE does not guarantee any specific trading
            ...
            applicable taxes. 4.3 ARBIQUE reserves the right to update pricing,
            ...
            may be corrected at ARBIQUE's sole discretion. 4.5 To access the
            ...
            ARBIQUE offers different Subscription Tiers with varying features,
