    ...
    <div className="relative w-full flex flex-col bg-[#05060f]  py-30 px-5 md:px-20 gap-10">
        ...
        <div>
          <p className="text-sm  md:text-md">
            Welcome to Qbot, a cloud-based crypto trading platform. We offer
            Qbot as a software solution ("Platform") through our website
            https://Qbot.com ("Website"). Our Platform provides users with an
            ...
            between Qbot and its customers, including details of our
            ...
            dispute resolution procedures. 1. Definitions 1.1 Qbot Account:
            The user account on the Platform, accessible only via the user's
            login credentials. 1.2 Platform: Qbot’s automated crypto trading
            system, enabling users to trade and invest through configurable
            strategies and tools. 1.3 Services: Collectively, the Qbot
            Platform and Website. 1.4 Fuel Wallet: The pre-funded digital wallet
            within the Qbot Account used for deducting profit-based
            ...
            legal entity utilizing Qbot's Services. 1.7 Login Credentials:
            The email address and password used to access an Qbot Account. 2.
            Registration & Personal Account 2.1 To access Qbot's Services,
            ...
            applicable laws and Qbot's internal policies. 2.3 Users are
            ...
            to Qbot immediately. 2.4 Users must ensure that all registration
            details and personal information provided are accurate, complete,
            and kept up-to-date. Qbot is not liable for any losses arising
            from outdated or inaccurate information. 2.5 Qbot reserves the
            ...
            3.1 Qbot provides an automated crypto trading assist tool. This
            ...
            Configuration: Users acknowledge and agree that Qbot is a
            software solution that executes trades based solely on the
            configurations and parameters set by the User. Qbot does not
            ...
            Guarantees: Qbot does not guarantee any specific trading
            ...
            applicable taxes. 4.3 Qbot reserves the right to update pricing,
            ...
            may be corrected at Qbot's sole discretion. 4.5 To access the
            ...
            Qbot offers different Subscription Tiers with varying features,
