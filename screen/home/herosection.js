  ...
  return (
    <div className="pt-30 w-full items-center justify-center flex-col text-center gap-5 ">
      <div className="w-full text-center justify-center">
        <div className="text-center justify-center inline-block px-6 py-2 text-xs sm:text-sm font-medium bg-white/10 backdrop-blur-md rounded-full shadow-md">
      ...
      <div className=" items-center w-full flex flex-col justify-center">
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold  leading-snug">
          ...
          Powered{" "}
          <span className="text-[#c1a8ff] relative">
            Crypto
            <span className="absolute -bottom-2 left-0 w-full h-1 bg-[#c1a8ff]/60 rounded-full"></span>
          </span>
        </h1>

        {/* Paragraph */}
        <p className="mt-6 w-full md:w-[70%]  text-sm sm:text-base md:text-lg text-gray-200  text-center">
