...
const Pricing = () => {
  ...
  return (
    <div> 
        <div className='flex items-center justify-center'><ToggleTabs
    options={[
...
<div className="relative bg-gradient-to-b from-[#1b1b2f] to-[#141424] rounded-3xl p-8 w-full max-w-sm shadow-lg border border-purple-800/30 m-2 md:m-10">
