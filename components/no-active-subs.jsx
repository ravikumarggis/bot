  ...
  return (
    <div className="min-h-[100%] w-full flex items-center justify-center">
      <div className="flex flex-col items-center text-center max-w-md">
        ...
        <h1 className="text-3xl font-semibold mb-3">No Active Subscription</h1>
        ...
        <p className="text-gray-500 mb-8 leading-relaxed">
          Enjoy premium features, faster access, and enhanced tools. Choose a
          plan that fits your trading needs and start your subscription today.
        </p>
